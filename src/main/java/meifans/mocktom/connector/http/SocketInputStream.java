...
public class SocketInputStream extends InputStream {
   ...
   * @throws IOException If an exception occurs during the underlying socket read operations, or if the given buffer is
   ...
   *                     not big enough to accomodate the whole line. =======
   * @throws IOException If an exception occurs during the underlying socket read operations, or if the given buffer is
   *                     not big enough to accomodate the whole line. >>>>>>> 0b8df34fd45c03f9f295838095e708d6cdead888
   */
